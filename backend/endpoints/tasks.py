...
from time_management_bot.backend.models.models import TaskCategory
from time_management_bot.backend.schemas.task import TaskNameUpdate, TaskToCategory
...
async def get_tasks(
    ...
    return ORJSONResponse([TaskModel(elem) for elem in tasks])
